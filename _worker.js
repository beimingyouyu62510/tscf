...
let 哎呀呀这是我的VL密钥 = "ab23f618-3f94-4d74-8c8b-d5703403b5be"; //建议更改为自己的标准化UUID

let 启用反代功能 = true //选择是否启用反代功能【总开关】，false，true，现在你可以自由的选择是否启用反代功能了
let 反代IP = '104.194.68.16:25222' //反代IP或域名，反代IP端口一般情况下不用填写，如果你非要用非标反代的话，可以填'ts.hpc.tw:443'这样
